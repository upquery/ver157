...
ws_sistema     = 'BI'
ws_versao      = '1.5.7'
ws_pasta_fonte = '..\\vDESENV' 
ws_pasta_plb   = '..\\vDESENV\\z_plb' 
ws_pasta_aux   = '..\\..\\..\\OUTROS' 
ws_user        = 'dwu'
ws_password    = '4wdyPel2SX49'
ws_dsn         = 'DESENV_PDB'

if os.path.exists(ws_pasta_aux + '\\plugins\\') == False: 
    ws_pasta_aux   = '..\\..\\..'

ws_tp_atualiza = sys.argv[1]

if sys.argv[1] == 'SISTEMA' or sys.argv[1] == 'SISTEMA_CHECK': 
    ws_arquivos = [ ['PKG',  'cfg'                   , ws_pasta_plb + '\\cfg\\'                      ,'N'],
                    ['PKG',  'etl'                   , ws_pasta_plb + '\\etl\\'                      ,'N'],
                    ['PKG',  'etf'                   , ws_pasta_plb + '\\etf\\'                      ,'N'],
				    ...
				    #['PKG',  'up_rel'                , ws_pasta_aux + '\\up_rel\\1.3.10\\'           ,'N'], 
				    #['PKG',  'aux'                   , ws_pasta_aux + '\\auxi\\ver1.5\\'             ,'N'],

				    ['ARQ',  'default-min.js'        , ws_pasta_fonte + '\\web\\'                    ,'N'],
                    ['ARQ',  'calendar.js'           , ws_pasta_fonte + '\\web\\'                    ,'N'],
                    #['ARQ',  'vanilla-masker.js'     , ws_pasta_aux   + '\\plugins\\'                ,'N'],                
				    #['ARQ',  'xlsx.mini.min.js'      , ws_pasta_aux   + '\\plugins\\'                ,'N'],
                    #['ARQ',  'echarts.5.1.js'        , ws_pasta_aux   + '\\plugins\\echarts\\'       ,'N'],
                    #['ARQ',  'pell.min.js'           , ws_pasta_aux   + '\\plugins\\pell\\dist\\'    ,'N'],
                    #['ARQ',  'qrcode.min.js'         , ws_pasta_aux   + '\\plugins\\qrcodejs\\'      ,'N'],
                    ['ARQ',  'html2pdf-min.js'       , ws_pasta_fonte + '\\web\\'                    ,'N'],
                    ['ARQ',  'html2canvas-min.js'    , ws_pasta_fonte + '\\web\\'                    ,'N'],
                    ['ARQ',  'jspdf.umd-min.js'      , ws_pasta_fonte + '\\web\\'                    ,'N'],

                    ['ARQ',  'default-min.css'       , ws_pasta_fonte + '\\web\\'                    ,'N'],
                    ...
                    #['ARQ',  'pell.min.css'          , ws_pasta_aux   + '\\plugins\\pell\\dist\\'    ,'N'],                                
                    ...
                    ['ARQ',  'etl_tipo_conexao.sql'  , '..\\update_scripts\\'                        ,'N'],
...
if sys.argv[1] == 'IMAGENS' or sys.argv[1] == 'IMAGENS_CHECK': 
    ws_arquivos = [ ['ARQ', 'bg.png'                  , '..\\imagens\\'                    ,'N'],
                    ['ARQ', 'loginup.png'             , '..\\imagens\\'                    ,'N'],
                    ['ARQ', 'logo_upquery.png'        , '..\\imagens\\'                    ,'N'],
                    ['ARQ', 'ipad.png'                , '..\\imagens\\'                    ,'N'],
                    ['ARQ', 'ipad_load.png'           , '..\\imagens\\'                    ,'N'],

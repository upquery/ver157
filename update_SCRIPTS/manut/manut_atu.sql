...
begin 
    ...
    -------------------------------------------------------
    --
    update var_conteudo set conteudo = 'update.upquery.com:7777/documentacao' where variavel = 'URL_AUTOUPDATE';
    update var_conteudo set conteudo = 'update.upquery.com:7777/documentacao' where variavel = 'URL_UPDATE';
    --
    -------------------------------------------------------
    -- FIM - atualiza 
    -------------------------------------------------------
